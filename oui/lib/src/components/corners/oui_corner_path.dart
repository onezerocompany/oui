...
enum OuiCorner { topLeft, topRight, bottomRight, bottomLeft }

extension OuiCornerExtensions on Path {
  ...
  void addOuiCorner(
    OuiCorner corner,
    ProcessedOuiCornerRadius radius,
    Rect rect,
  ) {
