...
class ScreenRegistry {
  final List<ScreenRegistryEntry> _entries;
  ...
  static List<ScreenRegistryEntry> _buildRegistry(
    Screen screen,
    Locale? locale,
  ) {
    final screens = <ScreenRegistryEntry>[];
    ...
    void addScreen(
      ...
      screens.add(ScreenRegistryEntry(screen, path, parents ?? []));
