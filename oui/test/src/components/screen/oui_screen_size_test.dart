...
import 'package:oui/src/components/screen/oui_screen_size.dart';

void main() {
  group('OuiScreenSizeDimension', () {
    test('default values', () {
      const dimension = OuiScreenSizeDimension();
      expect(dimension.minimum, 440);
  ...
  group('OuiScreenSize', () {
    test('default constructor', () {
      ...
      expect(screenSize.width.minimum, 440);
      expect(screenSize.width.maximum, 1400);
      expect(screenSize.width.weight, 1);
      expect(screenSize.height.minimum, 440);
