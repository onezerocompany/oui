...
void main() {
  group('CornerBorderRadius', () {
    test('constructor initializes correctly', () {
      ...
      final borderRadius =
          CornerBorderRadius(radius: radius, smoothing: smoothing);
    ...
    test('constructor handles null values gracefully', () {
      final borderRadius = CornerBorderRadius(radius: 10.0);
    ...
    test('constructor restricts negative radius or smoothing', () {
      expect(() => CornerBorderRadius(radius: -10.0), throwsAssertionError);
      expect(
        () => CornerBorderRadius(radius: 10.0, smoothing: -5.0),
        throwsAssertionError,
      );
    });

    test('horizontal constructor creates symmetric radii', () {
      const borderRadius = CornerBorderRadius.horizontal(
        left: CornerRadius(radius: 5.0, smoothing: 1.0),
      );
    ...
    test('toPath generates correct shape for rect', () {
      final borderRadius = CornerBorderRadius(radius: 10.0, smoothing: 0.8);
    ...
    test('lerp handles edge cases', () {
      ...
      final borderRadius1 =
          CornerBorderRadius(radius: radius1, smoothing: smoothing1);

      const radius2 = 20.0;
      const smoothing2 = 0.8;
      final borderRadius2 =
          CornerBorderRadius(radius: radius2, smoothing: smoothing2);

      final resultZero =
          CornerBorderRadius.lerp(borderRadius1, borderRadius2, 0.0);
      final resultOne =
          CornerBorderRadius.lerp(borderRadius1, borderRadius2, 1.0);
      final resultBeyond =
          CornerBorderRadius.lerp(borderRadius1, borderRadius2, 1.5);
    ...
    test('zero constant is initialized correctly', () {
      const zero = CornerBorderRadius.zero;
    ...
    test('lerp interpolates between two border radii', () {
      ...
      const t = 0.5;
      final result = CornerBorderRadius.lerp(borderRadius1, borderRadius2, t);
    ...
    test('toString returns correct string representation', () {
      ...
      expect(
        ...
        'CornerBorderRadius(topLeft: CornerRadius(cornerRadius: 10.00, smoothing: 0.50), topRight: CornerRadius(cornerRadius: 10.00, smoothing: 0.50), bottomLeft: CornerRadius(cornerRadius: 10.00, smoothing: 0.50), bottomRight: CornerRadius(cornerRadius: 10.00, smoothing: 0.50))',
      );
    });
  });
}
